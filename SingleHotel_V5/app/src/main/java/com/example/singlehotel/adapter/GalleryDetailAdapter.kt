...
class GalleryDetailAdapter(
    ...
    override fun instantiateItem(container: ViewGroup, position: Int): Any {
        ...
        val view = layoutInflater!!.inflate(R.layout.gallery_detail_adapter, container, false)
        val imageView = view.findViewById<TouchImageView>(R.id.imageView_gallery_detail_adapter)
        Glide.with(activity).load(galleryDetailLists[position].wallpaper_image)
