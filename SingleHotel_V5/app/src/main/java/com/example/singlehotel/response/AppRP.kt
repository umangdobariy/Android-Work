package com.example.singlehotel.responseimport
...
class AppRP : Serializable {
    ...
    val isBanner_ad = false

    @SerializedName("banner_ad_id")
    val banner_ad_id: String? = null

    @SerializedName("banner_ad_type")
    val banner_ad_type: String? = null

    @SerializedName("interstitial_ad")
    val isInterstitial_ad = false

    @SerializedName("interstitial_ad_id")
    val interstitial_ad_id: String? = null

    @SerializedName("interstitial_ad_click")
    val interstitial_ad_click: String? = null

    @SerializedName("interstitial_ad_type")
    val interstitial_ad_type: String? = null

    @SerializedName("privacy_policy_link")
    val privacy_policy_link: String? = null

    @SerializedName("app_update_status")
    val app_update_status: String? = null

    @SerializedName("app_new_version")
    val app_new_version = 0

    @SerializedName("app_update_desc")
    val app_update_desc: String? = null

    @SerializedName("app_redirect_url")
    val app_redirect_url: String? = null

    @SerializedName("cancel_update_status")
    val cancel_update_status: String? = null

    @SerializedName("startapp_app_id")
    val startapp_app_id: String? = null

    @SerializedName("nativ_ad_type")
    val native_ad_type: String? = null

    @SerializedName("nativ_ad")
    val isNative_ad = false

    @SerializedName("nativ_ad_id")
    val native_ad_id: String? = null

    @SerializedName("nativ_ad_position")
    val native_ad_position: String? = null
}