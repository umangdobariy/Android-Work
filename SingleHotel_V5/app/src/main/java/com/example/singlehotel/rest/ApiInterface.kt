package com.example.singlehotel.restimport
...
interface ApiInterface {
    ...
    @POST("api.php")
    @FormUrlEncoded
    fun getAppData(@Field("data") data: String?): Call<AppRP?>?

    //get about us
    @POST("api.php")
    @FormUrlEncoded
    fun getAboutUs(@Field("data") data: String?): Call<AboutUsRP?>?

    //get privacy policy
    @POST("api.php")
    @FormUrlEncoded
    fun getPrivacyPolicy(@Field("data") data: String?): Call<PrivacyPolicyRP?>?

    //get terms condition
    @POST("api.php")
    @FormUrlEncoded
    fun getTermsCondition(@Field("data") data: String?): Call<TermsConditionsRP?>?

    //get faq
    @POST("api.php")
    @FormUrlEncoded
    fun getFaq(@Field("data") data: String?): Call<FaqRP?>?

    //login
    @POST("api.php")
    @FormUrlEncoded
    fun getLogin(@Field("data") data: String?): Call<LoginRP?>?

    //register
    @POST("api.php")
    @FormUrlEncoded
    fun getRegister(@Field("data") data: String?): Call<RegisterRP?>?

    //forgot password
    @POST("api.php")
    @FormUrlEncoded
    fun getForgotPass(@Field("data") data: String?): Call<DataRP?>?

    //login check
    @POST("api.php")
    @FormUrlEncoded
    fun getLoginDetail(@Field("data") data: String?): Call<LoginRP?>?

    //get profile detail
    @POST("api.php")
    @FormUrlEncoded
    fun getProfile(@Field("data") data: String?): Call<ProfileRP?>?
    ...
    @POST("api.php")
    @FormUrlEncoded
    fun updatePassword(@Field("data") data: String?): Call<DataRP?>?

    //get contact subject
    @POST("api.php")
    @FormUrlEncoded
    fun getContactSub(@Field("data") data: String?): Call<ContactRP?>?

    //submit contact
    @POST("api.php")
    @FormUrlEncoded
    fun submitContact(@Field("data") data: String?): Call<DataRP?>?

    //home
    @POST("api.php")
    @FormUrlEncoded
    fun getHome(@Field("data") data: String?): Call<HomeRP?>?

    //room
    @POST("api.php")
    @FormUrlEncoded
    fun getRoom(@Field("data") data: String?): Call<RoomRP?>?

    //room detail
    @POST("api.php")
    @FormUrlEncoded
    fun getRoomDetail(@Field("data") data: String?): Call<RoomDetailRP?>?

    //review
    @POST("api.php")
    @FormUrlEncoded
    fun getReview(@Field("data") data: String?): Call<ReviewRP?>?

    //user review
    @POST("api.php")
    @FormUrlEncoded
    fun getUserReview(@Field("data") data: String?): Call<UserReviewRP?>?

    //submit review
    @POST("api.php")
    @FormUrlEncoded
    fun submitUserReview(@Field("data") data: String?): Call<UserReviewSubmitRP?>?

    //booking
    @POST("api.php")
    @FormUrlEncoded
    fun roomBooking(@Field("data") data: String?): Call<BookingRoomRP?>?

    //get gallery
    @POST("api.php")
    @FormUrlEncoded
    fun getGallery(@Field("data") data: String?): Call<GalleryCatRP?>?

    //get gallery detail
    @POST("api.php")
    @FormUrlEncoded
    fun getGalleryList(@Field("data") data: String?): Call<GalleryListRP?>?

    //facilities
    @POST("api.php")
    @FormUrlEncoded
    fun getFacilities(@Field("data") data: String?): Call<FacilitiesRP?>?

    //location
    @POST("api.php")
    @FormUrlEncoded
    fun getLocation(@Field("data") data: String?): Call<LocationRP?>?
}