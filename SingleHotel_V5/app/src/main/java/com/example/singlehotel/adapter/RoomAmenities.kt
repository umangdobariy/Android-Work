...
class RoomAmenities(
    ...
    private val roomAmenitiesLists: List<RoomAmenitiesList>
) : RecyclerView.Adapter<RoomAmenities.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RoomAmenities.ViewHolder {
        val view =
            LayoutInflater.from(activity).inflate(R.layout.room_amenities_adapter, parent, false)
        return RoomAmenities.ViewHolder(view)
    }

    override fun onBindViewHolder(holder: RoomAmenities.ViewHolder, position: Int) {
        holder.textViewAmenities.text =
            roomAmenitiesLists[position].room_amenities.trim { it <= ' ' }
    }
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        private val textViewAmenities: TextView
