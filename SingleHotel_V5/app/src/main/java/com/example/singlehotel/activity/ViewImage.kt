...
class ViewImage : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val method = Method(this@ViewImage)
        method.forceRTLIfSupported()
        val string = intent.getStringExtra("path")
        val toolbar = findViewById<MaterialToolbar>(R.id.toolbar_view_image)
        toolbar.title = ""
        ...
        val linearLayout = findViewById<LinearLayout>(R.id.linearLayout_view_image)
        method.showBannerAd(linearLayout)
        val imageView = findViewById<TouchImageView>(R.id.imageView_view_image)
        Glide.with(this@ViewImage).load(string)
