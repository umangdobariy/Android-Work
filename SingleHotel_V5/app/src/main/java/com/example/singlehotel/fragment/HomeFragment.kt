...
class HomeFragment : Fragment() {
    ...
    private var imageViewWhatsApp: ImageView? = null
    ...
    private var imageViewWeb: ImageView? = null
    ...
    override fun onCreateView(
        ...
        val view = LayoutInflater.from(context).inflate(R.layout.home_fragment, container, false)
        if (MainActivity.Companion.toolbar != null) {
            MainActivity.Companion.toolbar.setTitle(resources.getString(R.string.home))
        }
        onClick = OnClick { position: Int, type: String?, id: String?, title: String? ->
            when (type) {
                "room" -> activity!!.supportFragmentManager.beginTransaction().add(
                    R.id.frameLayout_main, RoomFragment(),
                    resources.getString(R.string.room)
                ).addToBackStack(resources.getString(R.string.room))
                    .commitAllowingStateLoss()
                "location" -> activity!!.supportFragmentManager.beginTransaction().add(
                    R.id.frameLayout_main, LocationFragment(),
                    resources.getString(R.string.location)
                ).addToBackStack(resources.getString(R.string.location))
                    .commitAllowingStateLoss()
                "facility" -> activity!!.supportFragmentManager.beginTransaction().add(
                    R.id.frameLayout_main, FacilitiesFragment(),
                    resources.getString(R.string.facilities)
                ).addToBackStack(
                    resources.getString(R.string.facilities)
                )
                    .commitAllowingStateLoss()
                "gallery" -> activity!!.supportFragmentManager.beginTransaction().add(
                    R.id.frameLayout_main, GalleryFragment(),
                    resources.getString(R.string.gallery)
                ).addToBackStack(resources.getString(R.string.gallery))
                    .commitAllowingStateLoss()
                "contactUS" -> activity!!.supportFragmentManager.beginTransaction().add(
                    ...
                    .commitAllowingStateLoss()
                "aboutUs" -> startActivity(Intent(activity, AboutUs::class.java))
            }
        }
        ...
        textViewAdd = view.findViewById(R.id.textView_add_home)
        val cardViewRoom = view.findViewById<MaterialCardView>(R.id.cardView_room_home)
        val cardViewLocation = view.findViewById<MaterialCardView>(R.id.cardView_location_home)
        val cardViewFacilities = view.findViewById<MaterialCardView>(R.id.cardView_facilities_home)
        val cardViewGallery = view.findViewById<MaterialCardView>(R.id.cardView_gallery_home)
        val cardViewContactUs = view.findViewById<MaterialCardView>(R.id.cardView_contactUs_home)
        val cardViewAboutUs = view.findViewById<MaterialCardView>(R.id.cardView_aboutUs_home)
        conMain.setVisibility(View.GONE)
        conNoData.setVisibility(View.GONE)
        progressBar.setVisibility(View.GONE)
        cardViewRoom.setOnClickListener { v: View? -> method!!.onClickAd(0, "room", "", "") }
        cardViewLocation.setOnClickListener { v: View? ->
            method!!.onClickAd(
                0,
                "location",
                "",
        ...
        cardViewFacilities.setOnClickListener { v: View? ->
            method!!.onClickAd(
                0,
                "facility",
                "",
        ...
        cardViewGallery.setOnClickListener { v: View? -> method!!.onClickAd(0, "gallery", "", "") }
        cardViewContactUs.setOnClickListener { v: View? ->
            method!!.onClickAd(
                0,
                "contactUS",
                "",
        ...
        cardViewAboutUs.setOnClickListener { v: View? -> method!!.onClickAd(0, "aboutUs", "", "") }
    ...
    fun home() {
        if (activity != null) {
            ...
            val call = apiService.getHome(API.Companion.toBase64(jsObj.toString()))
            call.enqueue(object : Callback<HomeRP?> {
                override fun onResponse(call: Call<HomeRP?>, response: Response<HomeRP?>) {
                    val statusCode = response.code()
                    if (activity != null) {
                        try {
                            val homeRP = response.body()!!
                            if (homeRP.status == "1") {
                                textViewTitle!!.text = homeRP.hotel_name
                                textViewAdd!!.text = homeRP.hotel_address
                                textViewEmail!!.text = homeRP.hotel_email
                                textViewPhone!!.text = homeRP.hotel_phone
                                if (homeRP.homeBanners.size != 0) {
                                ...
                                imageViewFacebook!!.setOnClickListener { v: View? ->
                                    imageViewFacebook!!.startAnimation(myAnim)
                                    val string = homeRP.facebook_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_facebook_link))
                                    } else {
                                        try {
                                ...
                                imageViewWhatsApp!!.setOnClickListener { v: View? ->
                                    imageViewWhatsApp!!.startAnimation(myAnim)
                                    val string = homeRP.whatsapp_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_whatsApp_link))
                                    } else {
                                        try {
                                            val intent = Intent(Intent.ACTION_VIEW)
                                            intent.data = Uri.parse(string)
                                ...
                                imageViewTwitter!!.setOnClickListener { v: View? ->
                                    imageViewTwitter!!.startAnimation(myAnim)
                                    val string = homeRP.twitter_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_twitter_link))
                                    } else {
                                        try {
                                            val intent = Intent(Intent.ACTION_VIEW)
                                            intent.data = Uri.parse(string)
                                ...
                                imageViewInstagram!!.setOnClickListener { v: View? ->
                                    imageViewInstagram!!.startAnimation(myAnim)
                                    val string = homeRP.instagram_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_instagram_link))
                                    } else {
                                        try {
                                ...
                                imageViewYouTube!!.setOnClickListener { v: View? ->
                                    imageViewYouTube!!.startAnimation(myAnim)
                                    val string = homeRP.youtube_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_youtube_link))
                                    } else {
                                        try {
                                            val intent = Intent(Intent.ACTION_VIEW)
                                            intent.data = Uri.parse(string)
                                ...
                                imageViewWeb!!.setOnClickListener { v: View? ->
                                    imageViewWeb!!.startAnimation(myAnim)
                                    val string = homeRP.website_url
                                    if (string == "") {
                                        method!!.alertBox(resources.getString(R.string.user_not_web_link))
                                    } else {
                                        try {
                                            val intent = Intent(Intent.ACTION_VIEW)
                                            intent.data = Uri.parse(string)
                                ...
                                method!!.alertBox(homeRP.message)
                            }
                        } catch (e: Exception) {
                ...
                override fun onFailure(call: Call<HomeRP?>, t: Throwable) {
