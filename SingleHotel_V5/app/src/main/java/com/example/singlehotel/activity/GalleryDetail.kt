...
class GalleryDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        method = Method(this@GalleryDetail, onClick)
        ...
        val toolbar = findViewById<MaterialToolbar>(R.id.toolbar_gallery_detail)
        toolbar.title = title
        ...
        val layoutManager =
            LinearLayoutManager(this@GalleryDetail, LinearLayoutManager.HORIZONTAL, false)
    ...
    private fun galleryDetail(cat_id: String?) {
        ...
        val jsObj = Gson().toJsonTree(API(this@GalleryDetail)) as JsonObject
        jsObj.addProperty("page", paginationIndex)
        jsObj.addProperty("cat_id", cat_id)
        jsObj.addProperty("method_name", "get_cat_by_gallery_id")
        val apiService = ApiClient.getClient().create(ApiInterface::class.java)
        val call = apiService.getGalleryList(API.Companion.toBase64(jsObj.toString()))
                ...
                try {
                    ...
                    if (galleryListRP.status == "1") {
                        if (galleryListRP.galleryDetailLists.size == 0) {
                            ...
                            galleryLists!!.addAll(galleryListRP.galleryDetailLists)
                        }
                        if (galleryListAdapter == null || galleryDetailAdapter == null) {
