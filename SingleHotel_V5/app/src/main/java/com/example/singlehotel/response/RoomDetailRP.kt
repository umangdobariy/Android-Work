...
class RoomDetailRP : Serializable {
    ...
    val room_image_thumb: String? = null

    @SerializedName("galley_image")
    val roomSliders: List<RoomSlider>? = null

    @SerializedName("room_description")
    val room_description: String? = null

    @SerializedName("room_rules")
    val room_rules: String? = null

    @SerializedName("room_price")
    val room_price: String? = null
    ...
    val roomAmenitiesLists: List<RoomAmenitiesList>? = null
}