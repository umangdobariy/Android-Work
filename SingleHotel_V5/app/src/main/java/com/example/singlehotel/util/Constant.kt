...
object Constant {
    ...
    var webTextLight = "#8b8b8b;"
    var webTextDark = "#FFFFFF;"

    //Change WebView link color light and dark mode
    var webLinkLight = "#0782C1;"
    var webLinkDark = "#0782C1;"
    const val AD_TYPE_ADMOB = "admob"
    const val AD_TYPE_FACEBOOK = "facebook"
    const val AD_TYPE_STARTAPP = "startapp"
    const val AD_TYPE_APPLOVIN = "applovins"

    //App detail
    var appRP: AppRP? = null
    var AD_COUNT = 0
    var interstitialAdShow = 0
    var nativeAdPos = 5
}